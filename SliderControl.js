L.Control.SliderControl = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    //   ui-slider-handle
      $(sliderContainer).append('<div id="leaflet-slider" style="width:200px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:13px; background-color:white; text-align:center; color:#ac1a2f; border-radius:5px; border: thin solid rgb(204, 204, 204);"></div></div>');
